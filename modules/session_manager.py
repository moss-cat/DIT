...
class SessionManager:
    ...
    def start_session(
        self, deck_name: str, cards_df: pd.DataFrame, mode: str = "sequential"
    ) -> None:
        """
    ...
    def end_session(self) -> Dict[str, Any]:
        ...
        stats = {
            ...
            "end_time": end_time,
            "duration_seconds": (
                end_time - st.session_state.study_start_time
            ).total_seconds(),
        }
    ...
    def get_progress(self) -> Dict[str, Union[int, float]]:
        ...
        return {
            ...
            "incorrect": incorrect,
            "current_index": (
                st.session_state.current_card_index + 1 if total > 0 else 0
            ),
        }
